    ...
    <AuthLayout>
      <Card className="w-full max-w-[420px] py-7 shadow-xl">
        <CardContent className="px-8 sm:px-9">
          ...
          <h1 className="mt-4 text-center font-heading text-[28px] font-bold leading-none">Forgot password</h1>
          <p className="mt-1.5 text-center text-[13px] text-muted-foreground">We will send a reset link if that email is registered.</p>
          <form
