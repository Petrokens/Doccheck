...
const SECTIONS = [
  ...
  { id: 4, name: 'Documents', display_order: 4 },
  { id: 5, name: 'Analytics', display_order: 5 },
  { id: 6, name: 'System', display_order: 6 },
...
const ITEMS = [
  ...
  { id: 16, section_id: 3, label: 'Report Templates', path: `${QA}/templates`, icon_name: 'FileText', display_order: 2 },
  { id: 17, section_id: 5, label: 'Score Trends', path: `${QA}/score-trends`, icon_name: 'TrendingUp', display_order: 1 },
  { id: 18, section_id: 5, label: 'Audit Logs', path: '/dashboard/audit-log', icon_name: 'Clipboard', display_order: 2 },
  { id: 19, section_id: 5, label: 'Document Stats', path: `${QA}/doc-statistics`, icon_name: 'PieChart', display_order: 3 },
  { id: 20, section_id: 6, label: 'System Status', path: '/dashboard/system-status', icon_name: 'Server', display_order: 1 },
  { id: 21, section_id: 6, label: 'Environment Config', path: '/dashboard/env-settings', icon_name: 'Sliders', display_order: 2 },
